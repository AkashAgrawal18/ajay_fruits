...
<!-- ========== Page Content ========== -->
<section class="py-5 d-flex align-items-center" style="background:#f3f3ff;min-height:100vh;">
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-4">
                <div class="card rounded-4 p-4 text-center border-0 shadow">
                    ...
                    <hr class="my-3">
                    <form action="<?= base_url('Login') ?>" class="text-start" method="post">
                        <label for="" class="small mb-0">Login id</label>
                        <input type="text" class="form-control" name="login_id" id="login_id" placeholder="Username" required>
