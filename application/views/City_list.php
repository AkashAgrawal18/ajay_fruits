      ...
      <div class="row justify-content-evenly g-0">
         <div class="col-7">
            ...
            <div class="table-responsive bg-light" style="height: 64vh;">
               <table id="city_tbl" class="my_custom_datatable table table-striped table-bordered dt-responsive nowrap">
                  <thead>
                     <tr>
                        <th width="5%">#</th>
                        <th>Name</th>
                     ...
                     ?>
                           <tr>
                              ...
                              <td title="Action" style="white-space: nowrap;">
                                 ...
                                 <?php // }
                                 // if ($logged_user_type == 1 || has_perm($logged_user_id, 'Mtr', 'city', 'Delete')) { 
                                 ?>
                                 <button class="btn btn-danger btn-sm btn-box btn-action delete-city" data-value="<?php echo $value->m_city_id; ?>" title="Delete" data-toggle="tooltip"><i class="bi bi-trash"></i></button>
                                 <?php // } 
                                 ?>
                              </td>
                           </tr>
                        ...
                        <div class="row mb-1">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <select name="m_city_line" id="m_city_line" class="form-control select2" title="Select Status" required>
                                    <option value="1">Select Group</option>
                                    <?php
                                    if (!empty($get_group)) {
                                       foreach ($get_group as $grp) {
                                    ?>
                                          <option value="<?php echo $grp->m_group_id; ?>" <?php if ($group == $grp->m_group_id) echo 'selected'; ?>><?php echo $grp->m_group_name; ?></option>
                                    <?php
                                       }
                                    }
                                    ?>
